...
def inject_powerbi_style():
    st.markdown(
        ...
        /* Keep only Streamlit's native >> sidebar opener visible. */
...
# The sidebar is the only page-navigation control.
if st.session_state.get("sidebar_module") not in module_keys:
